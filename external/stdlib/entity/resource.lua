...
-- @usage local Resource = require('__starcraft__/external/stdlib/entity/resource')
...
local Surface = require('__starcraft__/external/stdlib/area/surface')
local Area = require('__starcraft__/external/stdlib/area/area')
local Tile = require('__starcraft__/external/stdlib/area/tile')
local Queue = require('__starcraft__/external/stdlib/misc/queue')
