...
-- @usage local Position = require('__starcraft__/external/stdlib/area/position')
-- @see Area.Area
-- @see Concepts.Position
-- @see defines.direction
local Position = { __class = 'Position', __index = require('__starcraft__/external/stdlib/core') }
setmetatable(Position, Position)

local Direction = require('__starcraft__/external/stdlib/area/direction')
local Orientation = require('__starcraft__/external/stdlib/area/orientation')
...
local AREA_PATH = '__starcraft__/external/stdlib/area/area'
