...
require('__starcraft__/external/stdlib/core') -- Calling core up here to setup any required global stuffs
...
local groups = require('__starcraft__/external/stdlib/data/modules/groups')

local Data = {
    __class = 'Data',
    __index = require('__starcraft__/external/stdlib/core'),
    Sprites = require('__starcraft__/external/stdlib/data/modules/sprites'),
    Pipes = require('__starcraft__/external/stdlib/data/modules/pipes'),
    Util = require('__starcraft__/external/stdlib/data/modules/util'),
    _default_options = {
