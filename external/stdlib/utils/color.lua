...
-- @module Utils.Color
-- @usage local Color = require('__starcraft__/external/stdlib/utils/color')
...
local color_list = require('__starcraft__/external/stdlib/utils/defines/color_list')

--- @table color @{defines.color}
Color.color = require('__starcraft__/external/stdlib/utils/defines/color')
--- @table anticolor @{defines.anticolor}
Color.anticolor = require('__starcraft__/external/stdlib/utils/defines/anticolor')
--- @table lightcolor @{defines.lightcolor}
Color.lightcolor = require('__starcraft__/external/stdlib/utils/defines/lightcolor')
